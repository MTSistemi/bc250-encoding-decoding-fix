...
check "con tmvp" "$S1" 12 "bframes=0:temporal-mvp=1:qp=28"
...
check "GOP di 8" "$S1" 24 "keyint=8:bframes=3:qp=28"
check "long GOP" "$S1" 24 "keyint=24:bframes=3:qp=28"

echo
echo "partitions e blocks"
...
echo
echo "check_of di stream e tools"
